		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Buttons Page",
									"targetURL": "#sapdemobuttonsbuttonspage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdemobuttonsbuttonspage-display": {
								"semanticObject": "sapdemobuttonsbuttonspage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.demo.buttons.buttonspage",
									"url": sap.ui.require.toUrl("sap/demo/buttons/buttonspage")
								}
							}
						}
					}
